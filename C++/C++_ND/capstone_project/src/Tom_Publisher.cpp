...
void Tom_Publisher::run()
{
 ...
 /**
  * @brief Publisher behavior - Keep on checking for new connection and when it is added that client into client socket
  */ 
...
void Tom_Publisher::pub()
{
    ...
    //std::shared_ptr<const char> msg = temp.c_str();
